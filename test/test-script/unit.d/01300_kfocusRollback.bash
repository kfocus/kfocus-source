...
_overwriteWithMocksFn () {
  declare _exe_file _lib_file;
  # Source executable
  # bashsupport disable=BP2001
  _rootDir="${_t00RunDir}";
  # shellcheck disable=SC2154
  _exe_file="${_t00TopDir}";
  _exe_file+='/package-rollback/usr/lib/kfocus/bin/kfocus-rollback-backend';
  # shellcheck disable=SC1090,SC2154
  source "${_exe_file}" || exit 1;
  _lib_file="${_t00TopDir}";
  _lib_file+='/package-rollback/usr/lib/kfocus/lib/rollback.2.source';
  # shellcheck source=../../../package-rollback/usr/lib/kfocus/lib/rollback.2.source
  source "${_lib_file}" || exit 1;
